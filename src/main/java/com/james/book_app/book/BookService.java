package com.james.book_app.book;

import com.james.book_app.common.PageResponse;
import com.james.book_app.exception.OperationNotPermittedException;
import com.james.book_app.file.FileStorageService;
import com.james.book_app.history.BookTransactionHistory;
import com.james.book_app.history.BookTransactionHistoryRepository;
import com.james.book_app.user.User;
...
import static com.james.book_app.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer returnBorrowedBook(Integer bookId, Authentication connectedUser) throws OperationNotPermittedException {
        Book bookReturned = bookRepository.findById(bookId)
                .orElseThrow(() -> new EntityNotFoundException("No book found with ID:: " + bookId));
        if (bookReturned.isArchived() || !bookReturned.isShareable()) {
...
//        }
        BookTransactionHistory bookTransactionHistory = transactionHistoryRepository.findByBookIdAndUserId(bookId, bookReturned.getId())
